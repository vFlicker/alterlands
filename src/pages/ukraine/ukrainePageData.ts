...
const ukrainePageData = {
  ...
  menu: {
    first: [
      ...
      { title: 'Fundings', disabled: false },
      { title: 'Consult', disabled: false },
      { title: 'Budget', disabled: false },
      { title: 'Stats', disabled: false },
      { title: 'Relations', disabled: false },
      { title: 'Dashboard', disabled: false },
      { title: 'Authors', disabled: false },
      { title: 'Locations', disabled: false },
      { title: 'Media', disabled: false },
    ],
